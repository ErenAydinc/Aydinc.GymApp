...
public static class PersistenceServiceRegistration
{
    public static IServiceCollection AddPersistenceServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var baseDb = configuration.GetConnectionString("BaseDb");
        _ = services.AddDbContextPool<BaseDbContext>(
        options => options.UseMySql(baseDb,serverVersion:ServerVersion.AutoDetect(baseDb)));
        services.AddMvc();
        ...
        _ = services.AddScoped<IPersonalTrainerRepository, PersonalTrainerRepository>();
